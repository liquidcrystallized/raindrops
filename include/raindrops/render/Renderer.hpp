...
namespace raindrops
{
    ...
    public:
        ...
        void drawLine(float startX, float startY, float endX, float endY, int thickness, Colour colour) const;
        void drawCircle(float centreX, float centreY, float radius, Colour colour) const;

        void drawText(const std::string& text, float positionX, float positionY, int fontSize, Colour colour) const;
